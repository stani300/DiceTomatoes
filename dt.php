<?php
	...
	switch ( $action ) {
		case "recommendation":
			...
			$query = "SELECT m.*, SUBSTR(m.release_date,1,4) AS relyr, AVG(r.rating) AS avg_score FROM movies AS m JOIN ratings AS r ON r.movie_id=m.id WHERE relyr LIKE '" . $avgYr . "'" ;
