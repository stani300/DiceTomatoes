...
<body>
	...
	<div id="mpick" class="loginmodal">
		<div class="modal-content">

			<div class="LHead">Pick a Movie</div><br />
			...
			<table>
				...
				<tr>
					<td> <a onClick="addrating('aliens3')">Aliens3</a></td>
					<td>198x</td>
				</tr>
				<tr>
					<td>Aliens 4</td>
			...
			<div class="mybtngrp">
				<button id="mcancel" class="btn btn-danger mybtn" onclick="closempick()">CANCEL</button>
			</div>
	...
	<!-- end of splashscreen div -->


	<!-- browse div -->
	<div id="browse" class="blockHidden">
	...
	<!-- recommentations div -->
	<div id="recommendations" class="blockHidden">
		<div class="container">
			<div class="row">
				<div class="col-sm-2">
					<img src="images/dt100.png">
				...
				<div class="col-sm-10">
					...
					<p>enter some parameters</p>
					<p>get some suggestions</p>
		...
		<!-- end of recommendations div -->

		<!-- analytics div -->
	</div>
	<div id="analytics" class="blockHidden">
		<div class="container">
			<div class="row">
				<div class="col-sm-2">
					<img src="images/dt100.png">
